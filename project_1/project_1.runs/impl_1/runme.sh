...
HD_PWD='E:/Facultate/SEMESTRUL2/PSN/PROIECT FINAL/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log UnitateControl1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source UnitateControl1.tcl -notrace
