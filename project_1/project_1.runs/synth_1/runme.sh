...
HD_PWD='E:/Facultate/SEMESTRUL2/PSN/PROIECT FINAL/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log UnitateControl1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source UnitateControl1.tcl
